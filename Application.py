...
class Application:
    ...
    def update_info(self):
        ...
        if self.solver.avg_all_gens and self.solver.best_all_gens:
            self.viz.display_generation_info(self.solver.generation_number, self.solver.avg_all_gens[-1], self.solver.best_all_gens[-1])
